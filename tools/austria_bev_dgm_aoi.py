...
QUERY_MARGIN = 500.0     # m in GRID_CRS, slack so edge pixels have neighbours
...
class AustriaBevDgmAoi(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        rect = _aoi_rect(self, parameters, context,
                         QgsCoordinateReferenceSystem(GRID_CRS), margin=QUERY_MARGIN)
        if rect.isEmpty():
        ...
        rect_out = _aoi_rect_out(self, parameters, context, out_crs)
